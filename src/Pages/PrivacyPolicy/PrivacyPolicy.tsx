      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-[50%]">
          <p className="text-[18px] md:text-[24px] font-[700] text-white leading-none pb-5">
            Welcome to Creator's Mela! <br />
            <br />
            We are committed to protecting your privacy and ensuring you have a
            positive experience at our event. This Privacy Policy outlines our
            practices regarding the collection, use, and protection of your
            personal data through the event management system that consists of
            our website as well as mobile app.
          </p>
